...
The following images shows some more applications. Images without any red dashed-line box indicates that ASTRiDE did not detect any streaks in the images. Check them by yourself and see whether or not ASTRiDE did its job correctly. 

 <div align="center">
<img src="https://github.com/dwkim78/ASTRiDE/blob/master/astride/datasets/images/HorseHead.png" width="360">[ The Horse Head nebula. No streak is detected. ]</div>
