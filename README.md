...
The following images shows some more applications. 

|---|---|
| <div align="center"> <img src="https://github.com/dwkim78/ASTRiDE/blob/master/astride/datasets/images/dss2.png" width="500"><br/>[ [ESO DSS2](http://archive.eso.org/dss/dss) image. Three streaks are detected but only one looks like a real streak (i.e. ID=2)]</div> | <div align="center"> <img src="https://github.com/dwkim78/ASTRiDE/blob/master/astride/datasets/images/HorseHead.png" width="580"><br/>[ The Horsehead Nebula. No streak is detected. ]</div> |
